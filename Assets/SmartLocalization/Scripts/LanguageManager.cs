...
namespace SmartLocalization
{
	...
	public class LanguageManager : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		#region Static methods for editor
		...
		{
			var cultures = GetAvailableLanguageCultures();
			if (cultures == null) return null;
	
			return cultures.cultureInfos.ConvertAll(info => { return info.languageCode; }).ToArray();
		}
